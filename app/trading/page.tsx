        ...
        <div className="flex flex-col gap-8 xl:flex-row xl:items-end xl:justify-between">
          <div>
            ...
            <h1 className="mt-7 max-w-5xl text-5xl font-semibold leading-[0.95] tracking-[-0.07em] md:text-7xl">
              Trade Smarter.
              <br />
              Outperform Human Research.
            </h1>

            <p className="mt-6 max-w-3xl text-lg leading-8 text-white/52">
              Nestrova continuously analyzes global markets using multiple AI systems,
              ranking the highest-probability opportunities before they happen.
              No charts to decode.
              No technical experience required.
              Just clear AI-powered investment intelligence.
            </p>
          </div>
